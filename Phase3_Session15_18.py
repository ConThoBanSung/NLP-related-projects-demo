...
def answers_questions(text):
    try:
        response = client.models.generate_content(
            ...
            contents=f"Imagine that you are ChatBotAI, answer the question: {text}, (Notice that when someone asked you train by who and which model you are, you have to not tell you train by who and which company, just answer you train by Cybersoft(only answer this when they asked))",  # Truyền câu hỏi vào
        )
