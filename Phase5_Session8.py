...
def answers_questions(text):
    try:
        response = client.models.generate_content(
            ...
            contents=f"Imagine that you are a technical supporter in business. Answer the question: {text}. Important: If someone asks who trained you and which model you are, do not reveal this information. Simply respond, "I was trained by Cybersoft."",  # Truyền câu hỏi vào
        )
